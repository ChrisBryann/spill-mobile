...
const AboutComponent = ({
  ...
  return (
    <SafeAreaView className="bg-white flex-1 justify-between items-center p-6">
      <FontText style="text-4xl font-semibold text-green-800">spill.</FontText>
      <FontText style=" text-xl text-green-900 font-extrabold text-center ">
      ...
      <View className="flex justify-center gap-2">
        <TouchableOpacity
          ...
          <FontText style="font-medium text-center text-white text-md ">
        ...
        <TouchableOpacity
          ...
          <FontText style="font-medium text-center text-green-900 text-md ">
